--[[
Server Name: Horizon | CWRP
Server IP:   212.22.85.15:27017
File Path:   gamemodes/starwarsrp/gamemode/libraries/tdlib.lua
...
classes.FillHoverOver = function(pnl, col, dir, speed, mat)
	col = col || Color(255, 255, 255, 30)
	dir = dir || LEFT
	speed = speed || 8
...
classes.CircleHoverOver = function(pnl, col, speed, trad)
	col = col || Color(255, 255, 255, 30)
	speed = speed || 6
...
classes.StickMar = function(pnl, dock, margin1, margin2, margin3, margin4, dontInvalidate)
	dock = dock || FILL
	margin1 = margin1 || 0

	pnl:Dock(dock)
	if(margin1 > 0 or margin2 > 0 or margin3 > 0 or margin4 > 0) then
		pnl:DockMargin(margin1, margin2, margin3, margin4)
	end
