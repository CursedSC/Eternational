...
function ENT:Draw(f)
	...
	cam.Start3D2D( pos, angle, 0.01 )
		...
		draw.SimpleText( self:GetNWString("Name"), "Name_Font_Out", -tW / 2 + 17, -250, Color(0, 0, 0), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		draw.SimpleText( self:GetNWString("Name"), "Name_Font", -tW / 2 + 20, -250, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	cam.End3D2D()
