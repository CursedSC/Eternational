...
if (CLIENT) then
	SWEP.PrintName = "Меч с дополнительным покрытием"
end

SWEP.Category = "Оружие"
SWEP.ViewModel = "models/weapons/c_pistol.mdl"
SWEP.WorldModel = "models/cloudteam/fantasy/weapons/sword2.mdl" -- models/cloudteam/fantasy/weapons/sword.mdl
...
function SWEP:DoDamage(pos, comboInt)
	...
	for k, i in pairs(entityAttacked) do 
		...
		doAttackDamage(self.Owner, i, self, 25)
	end
end
