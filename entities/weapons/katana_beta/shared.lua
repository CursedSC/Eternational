...
SWEP.WorldModel = "models/cloudteam/fantasy/weapons/two_hand_sword9.mdl" -- models/cloudteam/fantasy/weapons/sword.mdl
SWEP.HoldType = "d_katana"
SWEP.Type = "sword"
SWEP.SphereSize = 60
SWEP.Spawnable = true
SWEP.BlockAnim = "h_block_forward_riposte"
SWEP.AttackList = {
	[1] = {
		seq = "arc_atksword1",
		cd = 0.7,
